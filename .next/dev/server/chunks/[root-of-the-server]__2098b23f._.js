...
"[project]/webui-devops/Naratel-Devops-Dashboard/src/app/api/manifest/delete/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
        ...
        try {
            ...
            if (__TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].existsSync(appsPath)) {
                ...
                files.forEach((file)=>{
                    ...
                    if (file === `${appName}-prod` || file === `${appName}-testing` || file === `${appName}-db-prod` || file === `${appName}-db-testing`) {
            ...
            let jenkinsMessage = '';
            try {
                const jenkinsResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$webui$2d$devops$2f$Naratel$2d$Devops$2d$Dashboard$2f$src$2f$lib$2f$jenkins$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deleteJob"])(appName);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2098b23f._.js.map