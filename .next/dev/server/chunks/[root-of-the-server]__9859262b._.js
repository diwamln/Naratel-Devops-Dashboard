...
"[project]/webui-devops/Naratel-Devops-Dashboard/src/app/api/manifest/update-image/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    try {
        ...
        if (!appName || !env || !imageTag) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$webui$2d$devops$2f$Naratel$2d$Devops$2d$Dashboard$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "appName, env, and imageTag are required"
            }, {
                status: 400
            });
        }
        ...
        return await __TURBOPACK__imported__module__$5b$project$5d2f$webui$2d$devops$2f$Naratel$2d$Devops$2d$Dashboard$2f$src$2f$lib$2f$gitMutex$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["gitMutex"].runExclusive(async ()=>{
            ...
            const targetFolder = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(repoPath, 'apps', `${appName}-${env}`);
            ...
            if (!__TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].existsSync(valuesPath)) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$webui$2d$devops$2f$Naratel$2d$Devops$2d$Dashboard$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    error: `Manifest folder for ${appName}-${env} not found.`
                }, {
                    status: 404
                });
            }
            // 2. Read & Update Yaml
            const fileContent = __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].readFileSync(valuesPath, 'utf8');
            let values = __TURBOPACK__imported__module__$5b$project$5d2f$webui$2d$devops$2f$Naratel$2d$Devops$2d$Dashboard$2f$node_modules$2f$js$2d$yaml$2f$dist$2f$js$2d$yaml$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].load(fileContent);
            // Update Tag
            if (values.image) {
                values.image.tag = imageTag;
            } else {
                return __TURBOPACK__imported__module__$5b$project$5d2f$webui$2d$devops$2f$Naratel$2d$Devops$2d$Dashboard$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    error: "Invalid values.yaml structure: missing image key"
                }, {
                    status: 400
                });
            }
            // Write Back
            __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].writeFileSync(valuesPath, __TURBOPACK__imported__module__$5b$project$5d2f$webui$2d$devops$2f$Naratel$2d$Devops$2d$Dashboard$2f$node_modules$2f$js$2d$yaml$2f$dist$2f$js$2d$yaml$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].dump(values));
            // 3. Commit & Push
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$webui$2d$devops$2f$Naratel$2d$Devops$2d$Dashboard$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: `Successfully updated ${appName}-${env} to tag ${imageTag}`
            });
        });
    } catch (err) {
        console.error(err);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9859262b._.js.map