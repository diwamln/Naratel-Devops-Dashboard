...
"[project]/webui-devops/Naratel-Devops-Dashboard/src/app/api/manifest/next-id/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    return await __TURBOPACK__imported__module__$5b$project$5d2f$webui$2d$devops$2f$Naratel$2d$Devops$2d$Dashboard$2f$src$2f$lib$2f$gitMutex$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["gitMutex"].runExclusive(async ()=>{
        ...
        try {
            ...
            const enrichedRegistry = registry.map((app)=>{
                const prodValuesPath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(repoPath, 'apps', `${app.name}-prod`, 'values.yaml');
                const testValuesPath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(repoPath, 'apps', `${app.name}-testing`, 'values.yaml');
                let prodHost = null;
                let testHost = null;
                // Read Prod
                if (__TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].existsSync(prodValuesPath)) {
                    try {
                        const doc = __TURBOPACK__imported__module__$5b$project$5d2f$webui$2d$devops$2f$Naratel$2d$Devops$2d$Dashboard$2f$node_modules$2f$js$2d$yaml$2f$dist$2f$js$2d$yaml$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].load(__TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].readFileSync(prodValuesPath, 'utf8'));
                        if (doc.ingress && doc.ingress.enabled && doc.ingress.hosts && doc.ingress.hosts.length > 0) {
                            prodHost = doc.ingress.hosts[0].host;
                        }
                    } catch (e) {
                        console.warn(`Failed to read prod values for ${app.name}`, e);
                    }
                }
                // Read Testing
                if (__TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].existsSync(testValuesPath)) {
                    try {
                        const doc = __TURBOPACK__imported__module__$5b$project$5d2f$webui$2d$devops$2f$Naratel$2d$Devops$2d$Dashboard$2f$node_modules$2f$js$2d$yaml$2f$dist$2f$js$2d$yaml$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].load(__TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].readFileSync(testValuesPath, 'utf8'));
                        if (doc.ingress && doc.ingress.enabled && doc.ingress.hosts && doc.ingress.hosts.length > 0) {
                            testHost = doc.ingress.hosts[0].host;
                        }
                    } catch (e) {
                        console.warn(`Failed to read test values for ${app.name}`, e);
                    }
                }
                return {
                    ...app,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__853f6811._.js.map