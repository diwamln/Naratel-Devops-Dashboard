        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-8 flex flex-col md:flex-row md:items-end md:justify-between gap-4">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-neutral-900 hover:bg-neutral-50 dark:hover:bg-neutral-800 text-neutral-700 dark:text-neutral-300 rounded-lg text-sm font-bold transition-all border border-neutral-200 dark:border-neutral-800 shadow-sm"
            >
              <LayoutGrid size={16} className="text-[#FFA500]" />
              Tools & Services
            </button>
          </div>
          ...
          {/* Feedback Message */}
          {message.text && (
            <div className={`mb-6 p-4 rounded-lg border flex items-center gap-3 text-sm ${message.type === 'success'
                ...
                <div className="bg-white dark:bg-neutral-900 p-6 rounded-xl border border-neutral-200 dark:border-neutral-800 shadow-sm">
                  ...
                  {!appFileName && (
                    <div
                      ...
                      className={`mb-4 border border-dashed rounded-lg p-6 text-center transition-all cursor-pointer ${isDraggingApp
                    ...
                    <div className="animate-in fade-in slide-in-from-top-2 border-t border-neutral-100 dark:border-neutral-800 pt-6">
                      ...
                      {!dbFileName && (
                        <div
                          ...
                          className={`mb-4 border border-dashed rounded-lg p-6 text-center transition-all cursor-pointer ${isDraggingDb
                              ? 'border-[#FFA500] bg-[#FFA500]/10'
                              : 'border-neutral-300 dark:border-neutral-700 bg-gray-50/50 dark:bg-neutral-950/50 hover:border-neutral-400 dark:hover:border-neutral-600'
                            }`}
                        >
                        ...
                        {form.dbSecrets.map((secret, idx) => (
                          <div key={idx} className="flex gap-2 items-start">
                            ...
                            {!form.separateDbSecrets ? (
                              <input placeholder="VALUE"
                                className={`flex-1 p-2 text-xs border rounded dark:bg-neutral-950 dark:border-neutral-800 ${(secret.key === 'POSTGRES_PASSWORD' || secret.key === 'MYSQL_ROOT_PASSWORD') && !secret.value
                              ...
                              <div className="flex-1 flex flex-col gap-2">
                                <input placeholder="VALUE (PRODUCTION)"
                                  className={`w-full p-2 text-xs border rounded dark:bg-neutral-950 ${(secret.key === 'POSTGRES_PASSWORD' || secret.key === 'MYSQL_ROOT_PASSWORD') && !secret.valueProd
                                      ? 'border-red-500 ring-1 ring-red-500'
                                ...
                                />
                                <input placeholder="VALUE (TESTING)"
                                  className={`w-full p-2 text-xs border rounded dark:bg-neutral-950 ${(secret.key === 'POSTGRES_PASSWORD' || secret.key === 'MYSQL_ROOT_PASSWORD') && !secret.valueTest
                                      ? 'border-red-500 ring-1 ring-red-500'
